...
def test_ae_shapes():
    ...
    assert tuple(reconstructed.shape) == (1, 1, 64, 64), f"AE Decoder failed. Expected (1, 1, 64, 64), got {reconstructed.shape}"
...
def test_vae_shapes():
    ...
    assert tuple(reconstructed.shape) == (1, 1, 64, 64), "VAE Decoder shape is incorrect."
